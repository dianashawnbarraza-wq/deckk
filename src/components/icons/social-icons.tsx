...
/** Venmo wordmark glyph (simplified V mark). */
function VenmoIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={className} aria-hidden fill="currentColor">
      <path d="M19.0 4.07c.35.58.62 1.24.8 1.92.48 1.96.34 4.4-.37 7.38C18.44 17.05 16.35 20 13.2 20c-1.72 0-3.01-1.02-3.68-2.76L6.3 4.5h3.53l2.75 11.1c.2.8.67 1.2 1.28 1.2 1.54 0 2.86-1.9 3.37-4.32.53-2.5.57-4.44.18-5.7-.19-.6-.5-1.1-.9-1.47L19 4.07Z" />
    </svg>
  );
}
